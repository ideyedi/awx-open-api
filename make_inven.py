...
class AnsibleCrawler:
    ...
    def make_inven(self):
        ...
        try:
            ...
            self.driver.implicitly_wait(1)
            btn_sync = self.driver.find_elements(By.CLASS_NAME, "pf-m-secondary")
            btn_sync = btn_sync[1]
            btn_sync.click()
...
crawler = AnsibleCrawler(profile=param['profile'], app_name=param['project'], project=param['awx_project'])
print(f'Crawler {crawler.app_name}')
